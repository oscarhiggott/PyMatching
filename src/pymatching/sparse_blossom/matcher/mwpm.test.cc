...
TEST(Mwpm, BlossomCreatedThenShattered) {
    ...
    g.add_edge(0, 1, 10, {0}, /*implied_weights_unconverted=*/{});
    g.add_edge(1, 4, 20, {1}, /*implied_weights_unconverted=*/{});
    g.add_edge(4, 3, 20, {0, 1}, /*implied_weights_unconverted=*/{});
    g.add_edge(3, 2, 12, {2}, /*implied_weights_unconverted=*/{});
    g.add_edge(0, 2, 16, {0, 2}, /*implied_weights_unconverted=*/{});
    g.add_edge(4, 5, 50, {1, 2}, /*implied_weights_unconverted=*/{});
    g.add_edge(2, 6, 100, {0, 1, 2}, /*implied_weights_unconverted=*/{});
    g.add_boundary_edge(5, 36, {3}, /*implied_weights_unconverted=*/{});
...
TEST(Mwpm, ShatterBlossomAndExtractMatchesForPair) {
    ...
    for (size_t i = 0; i < num_nodes - 1; i++)
        g.add_edge(i, i + 1, 2, obs_mask_to_set_bits(i), /*implied_weights_unconverted=*/{});
    auto& ns = mwpm.flooder.graph.nodes;
...
TEST(Mwpm, TwoRegionsGrowingThenMatching) {
    ...
    auto& g = mwpm.flooder.graph;
    g.add_boundary_edge(0, 4, {0, 1}, /*implied_weights_unconverted=*/{});
    g.add_edge(0, 1, 100, {0, 2}, /*implied_weights_unconverted=*/{});
    g.add_edge(1, 2, 22, {0, 2}, /*implied_weights_unconverted=*/{});
    g.add_edge(2, 3, 30, {0}, /*implied_weights_unconverted=*/{});
    g.add_edge(3, 4, 10, {0, 3}, /*implied_weights_unconverted=*/{});
    g.add_boundary_edge(4, 1000, {1}, /*implied_weights_unconverted=*/{});
...
TEST(Mwpm, RegionHittingMatchThenMatchedToOtherRegion) {
    Mwpm mwpm(GraphFlooder(MatchingGraph(10, 64)));
    auto& g = mwpm.flooder.graph;
    g.add_boundary_edge(0, 1000, {0, 1}, /*implied_weights_unconverted=*/{});
    g.add_edge(0, 1, 8, {0, 2}, /*implied_weights_unconverted=*/{});
    g.add_edge(1, 2, 10, {0, 2}, /*implied_weights_unconverted=*/{});
    g.add_edge(2, 3, 2, {0}, /*implied_weights_unconverted=*/{});
    g.add_edge(3, 4, 4, {0, 3}, /*implied_weights_unconverted=*/{});
    g.add_edge(4, 5, 20, {1}, /*implied_weights_unconverted=*/{});
    g.add_edge(5, 6, 36, {0, 1}, /*implied_weights_unconverted=*/{});
    g.add_boundary_edge(6, 1000, {1}, /*implied_weights_unconverted=*/{});
    mwpm.create_detection_event(&mwpm.flooder.graph.nodes[1]);
...
TEST(Mwpm, RegionHittingMatchFormingBlossomThenMatchingToBoundary) {
    ...
    auto& g = mwpm.flooder.graph;
    g.add_boundary_edge(0, 2, {0}, /*implied_weights_unconverted=*/{});
    for (size_t i = 0; i < num_nodes - 1; i++)
        g.add_edge(i, i + 1, 2, obs_mask_to_set_bits(i), /*implied_weights_unconverted=*/{});
    g.add_boundary_edge(num_nodes - 1, 2, {1}, /*implied_weights_unconverted=*/{});
...
TEST(GraphFlooder, CreateRegion) {
    ...
    g.add_boundary_edge(0, 3, {}, /*implied_weights_unconverted=*/{});
    g.add_edge(0, 1, 5, {}, /*implied_weights_unconverted=*/{});
    g.add_edge(1, 2, 11, {}, /*implied_weights_unconverted=*/{});
    g.add_edge(2, 3, 100, {}, /*implied_weights_unconverted=*/{});
    g.add_boundary_edge(3, 1000, {}, /*implied_weights_unconverted=*/{});
...
TEST(GraphFlooder, RegionGrowingToBoundary) {
    ...
    auto& flooder = mwpm.flooder;
    auto& g = flooder.graph;
    g.add_boundary_edge(0, 2, {0, 1}, /*implied_weights_unconverted=*/{});
    g.add_edge(0, 1, 10, {0, 2}, /*implied_weights_unconverted=*/{});
    g.add_edge(1, 2, 21, {}, /*implied_weights_unconverted=*/{});
    g.add_edge(2, 3, 100, {0}, /*implied_weights_unconverted=*/{});
    g.add_edge(3, 4, 7, {0, 3}, /*implied_weights_unconverted=*/{});
    g.add_boundary_edge(4, 5, {1}, /*implied_weights_unconverted=*/{});
    mwpm.create_detection_event(&flooder.graph.nodes[2]);
    ASSERT_EQ(
...
TEST(GraphFlooder, RegionHitRegion) {
    ...
    auto& flooder = mwpm.flooder;
    auto& g = flooder.graph;
    g.add_boundary_edge(0, 2000, {0, 1}, /*implied_weights_unconverted=*/{});
    g.add_edge(0, 1, 10, {0, 2}, /*implied_weights_unconverted=*/{});
    g.add_edge(1, 2, 24, {}, /*implied_weights_unconverted=*/{});
    g.add_edge(2, 3, 38, {0}, /*implied_weights_unconverted=*/{});
    g.add_edge(3, 4, 26, {0, 3}, /*implied_weights_unconverted=*/{});
    g.add_boundary_edge(4, 1000, {1}, /*implied_weights_unconverted=*/{});
    mwpm.create_detection_event(&flooder.graph.nodes[2]);
...
TEST(GraphFlooder, RegionGrowingThenFrozenThenStartShrinking) {
    ...
    g.add_boundary_edge(0, 4, {0, 1}, /*implied_weights_unconverted=*/{});
    g.add_edge(0, 1, 10, {0, 2}, /*implied_weights_unconverted=*/{});
    g.add_edge(1, 2, 22, {}, /*implied_weights_unconverted=*/{});
    g.add_edge(2, 3, 30, {0}, /*implied_weights_unconverted=*/{});
    g.add_edge(3, 4, 50, {0, 3}, /*implied_weights_unconverted=*/{});
    g.add_boundary_edge(4, 100, {1}, /*implied_weights_unconverted=*/{});
    mwpm.create_detection_event(&flooder.graph.nodes[2]);
    auto e1 = flooder.run_until_next_mwpm_notification();
    ASSERT_EQ(
        e1,
