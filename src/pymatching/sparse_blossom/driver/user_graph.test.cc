...
TEST(UserGraph, ConstructGraph) {
    ...
    ASSERT_EQ(graph.nodes[0].neighbors[0]->node2, SIZE_MAX);
    ...
    ASSERT_EQ(graph.nodes[0].neighbors[1]->node2, 1);
    ...
    ASSERT_EQ(graph.nodes[1].neighbors[0]->node1, 0);
    ASSERT_EQ(graph.nodes[2].neighbors[0]->node1, 1);
    ASSERT_EQ(graph.nodes[2].neighbors[1]->node2, 3);
